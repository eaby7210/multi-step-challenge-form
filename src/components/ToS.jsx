...
<div className="space-y-6">
  ...
  <div className="py-16 px-4">
    <div className="max-w-screen-xl mx-auto space-y-6 text-gray-800">
      ...
      <p>
        ...
        <a href="https://investorbootz.com" className="text-blue-600 underline">
          https://investorbootz.com
        </a>{' '}
      ...
      <p>
        These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (<strong>“you”</strong>), and InvestorBootz, LLC, concerning your access to and use of the Services...
      </p>

      {/* Table of Contents */}
      <p className="text-lg font-bold mt-8">TABLE OF CONTENTS</p>
 ...
 <ol className="list-decimal pl-6">
    <li className="font-bold text-lg">OUR SERVICES</li>
  </ol>
  <p>
  ...
  <ol start={2} className="list-decimal pl-6">
    <li className="font-bold text-lg">INTELLECTUAL PROPERTY RIGHTS</li>
  </ol>

  <h3 className="font-semibold text-base sm:text-lg">Our intellectual property</h3>
  <p>
  ...
  <h3 className="font-semibold text-base sm:text-lg">Your use of our Services</h3>
  <p>
  ...
  <p>
    If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:support@example.com" className="text-blue-600 hover:underline">[email&nbsp;protected]</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
  </p>
  <p>
  ...
  <h3 className="font-semibold text-base sm:text-lg">Your submissions and contributions</h3>
  <p>
...
<ul className="list-disc pl-5 space-y-2">
    <li>
      ...
      <a href="#prohibited" className="text-blue-600 underline hover:text-blue-800">
  ...
  <h2 className="text-lg font-bold mt-6">3. USER REPRESENTATIONS</h2>
  <p>
  ...
  <h2 className="text-lg font-bold mt-6">4. USER REGISTRATION</h2>
  <p>
    You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.
  </p>

  <h2 className="text-lg font-bold mt-6">5. PURCHASES AND PAYMENT</h2>
  ...
  <p>
    ...
    <p className="text-gray-700 mt-4">As a user of the Services, you agree not to:</p>
...
Visiting the Services, sending us emails, and completing online forms constitute electronic communications. You consent to receive electronic communications, and you agree that all agreements, notices, disclosures, and other communications we provide to you electronically, via email and on the Services, satisfy any legal requirement that such communication be in writing. YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICES. You hereby waive any rights or requirements under any statutes, regulations, rules, ordinances, or other laws in any jurisdiction which require an original signature or delivery or retention of non-electronic records, or to payments or the granting of credits by any means other than electronic means.
  ...
  <div className="space-y-1 text-base text-gray-800 font-semibold">
    ...
    <p>
      ...
      {/*here ends the main content section*/}
    </div>
  </div>
</div>
