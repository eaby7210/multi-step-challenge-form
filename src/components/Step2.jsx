    ...
    <>
      <div className="flex flex-col flex-1">
        <div className="mb-6">
          ...
          >
            Street Address{" "}
            {/* <span className="text-main text-xs opacity-60">(optional)</span> */}
          </label>
          <div className="relative">
            ...
            />
            <Map className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-primary pointer-events-none" />
          </div>
          {nextClicked && (
            <div className="mt-2">
              {!formData.state && (
                <div className="text-red-600 text-start text-xs">
                  State is required.
                </div>
              )}
            </div>
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                className="bg-card border border-primary text-main text-sm  focus:ring-primary focus:border-primary block w-full p-2.5 transition-all duration-200 shadow-sm focus:shadow-md"
                required
                ...
                {(!formData.postalCode || formData.postalCode.length > 10) && (
                  <div className="text-red-600 text-start text-xs">
                    {!formData.postalCode
                      ...
                      : "Postal code cannot be more than 10 characters."}
                  </div>
                )}
              </div>
            )}
